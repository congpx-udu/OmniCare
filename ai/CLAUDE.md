...
| `app/schemas/` | `chat.py`: ChatRequest/ChatResponse; `insight.py`: WeatherInsightRequest/Response; `ocr.py`: OcrRequest (1–8 trang ảnh base64) / OcrResponse (một JSON gộp). |
